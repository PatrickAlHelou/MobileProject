...
public class WorkoutDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sqlinsert = "insert into Workouts (title, sets, reps, day, image) Values ('Abs' , 4 , 8 , 'Monday' , 'https://live.staticflickr.com/65535/52883917984_cb9c6d377a_o.png')";
        String sqlinsert2 = "insert into Workouts (title, sets, reps, day, image) Values ('Arms' , 3 , 12 , 'Monday' , 'https://live.staticflickr.com/65535/52884214848_48582619b2_o.png')";
